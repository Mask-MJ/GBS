    ...
    computed: {
        ...
        activeMinutes() {
            ...
            for (var video of this.videos) {
                ...
                var duration_start, duration_end;
                if(this.start) {
                ...
                for(var i=0;;i+=this.minutesPerUnit) {
                    ...
                    if(duration_start && c.isBefore(duration_start, "minute")) {
                        continue;
                    }
                    if(duration_end && c.isAfter(duration_end, "minute")) {
                        break;
                    }
