    ...
    <FormDlg :title="title" @hide="onHide" @show="onShow" @submit="onSubmit" ref="dlg" :disabled="errors.any()">
        ...
        <div :class="{'form-group':true, 'has-error': errors.has('target')}">
            ...
            <div class="col-sm-7 checkbox">
                <el-radio style="margin-left:-19px;margin-top:-5px;" size="small" v-model="form.target" label="cascade" @change="changeTarget" v-show="vtype != '标准版'">上级平台&nbsp;&nbsp;&nbsp;&nbsp;</el-radio>
    ...
    methods: {
        ...
        show(data) {
            ...
            if(data) {
                ...
                this.form.devtree = !!data.devtree;
            }
            if(this.vtype != '标准版') {
                this.form.target = 'cascade';
                this.loadCascade();
