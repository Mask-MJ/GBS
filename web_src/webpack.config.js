...
module.exports = {
  entry: {
    ...
    "playback": ['babel-polyfill', resolve('playback.js')],
    "map": ['babel-polyfill', resolve('map.js')]
  },
  output: {
  ...
  devServer: {
    ...
    proxy: {
      "**/ws-flv/**/*.flv": {
        target: `ws://http://192.168.5.11:10000/`,
        changeOrigin: false,
        ws: true,
        secure: false
      },
      "**/ws-talk/**": {
        // target: `https://gbs.liveqing.com:10010/`,
        target: `ws://http://192.168.5.11:10000/`,
        changeOrigin: false,
        ws: true,
        secure: false
      ...
      "*": {
        target: `https://gbs.liveqing.com:10010/`,
        // target: 'http://192.168.5.11:10000/',
        changeOrigin: false,
        secure: false
      }
    }
